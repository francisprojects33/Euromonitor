...
namespace EUROMONITOR.Model.Migrations
{
    ...
    [Migration("20210825154446_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EUROMONITOR.Model.Book", b =>
                {
            ...
            modelBuilder.Entity("EUROMONITOR.Model.Subscription", b =>
                {
            ...
            modelBuilder.Entity("EUROMONITOR.Model.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EUROMONITOR.Model.Subscription", b =>
                {
                    b.HasOne("EUROMONITOR.Model.Book", "Book")
                        .WithMany("Subscriptions")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EUROMONITOR.Model.User", "User")
                        .WithMany("Subscriptions")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EUROMONITOR.Model.User", null)
                        .WithMany()
